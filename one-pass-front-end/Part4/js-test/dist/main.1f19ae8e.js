...
var result = 'Hello world!'.indexOf('Heropy');
console.log(result); // 05. 객체
...
console.log(values); // 06. 구조 분해 할당

var heropy = user.name,
    age = user.age,
    email = user.email,
    _user$address = user.address,
    address = _user$address === void 0 ? 'Korea' : _user$address;
console.log("\uC0AC\uC6A9\uC790\uC758 \uC774\uB984\uC740 ".concat(heropy, "\uC785\uB2C8\uB2E4."));
console.log("".concat(heropy, "\uC758 \uB098\uC774\uB294 ").concat(age, "\uC138\uC785\uB2C8\uB2E4."));
console.log(address);
var fruits = ['Apple', 'Banana', 'Cherry', 'Orange'];
var b6 = fruits[1],
    c6 = fruits[2],
    d6 = fruits[3];
console.log(b6, c6, d6); // 07. 전개 연산자
...
console.log(toObject.apply(void 0, fruits)); // 08. 불변성
...
console.log('copyUser', copyUser9); // const copyUser9_1 = Object.assign({}, user9);

var copyUser9_1 = _objectSpread({}, user9);
...
var copyUser9_2 = _lodash.default.cloneDeep(user9);
